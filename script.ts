...
const resumeDisplayElement1 = document.getElementById('resume-display') as
HTMLDivElement;

const shareableLinkContainer1 = document.getElementById('shareable-link-container') as HTMLDivElement;

const shareableLinkElement1 = document.getElementById('shareable-link') as
HTMLAnchorElement;
const downloadPdfButton1 = document.getElementById('download-pdf') as
HTMLButtonElement;
...
shareableLinkElement1.textContent = shareableURL;
});
// Handle PDF download
